...
import musicAcademyImage from '../assets/music-academy.png';
import jobportalImage from '../assets/job-portal.png';
import interviewPlateformImage from '../assets/video-Interview .png';

const projects = [
  {
    id: 1,
    title: "Music Academy",
    description: "The Music Academy project, developed with Next.js, provides an engaging, high-performance platform for music education. Utilizing Next.js’ server-side rendering (SSR) and static site generation (SSG), it ensures fast load times, enhancing user experience. The platform includes personalized user dashboards, enabling students to track progress and enroll in classes",
  ...
  },
  {
    id: 2,
    title: "JOB PORTAL",
    description: "Users can search and apply for jobs that fit their preferences and skill set. Employers can create profiles, post job openings, manage applications, and interact with potential candidates through a dedicated dashboard.",
